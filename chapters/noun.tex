...
\begin{itemize}
    \item 属格： \\
          \begin{itemize}
              \item 单数名词只有阳中的属格加-(e)s
              \item 多音节-s,单音节-es，嘶擦或sch加-es
              \item 人、地、中性国名，属格像英。前置，加-s，嘶擦情况加一撇 \\
                    Julians Schwester ist eine bekannte Schwimmerin. \\
                    Franz' Arbeit gefällt ihm nicht.
          \end{itemize}
    \item 与格： \\
          复数名词与格加-n
    \item 弱阳：\\
          阳性名词中有部分“弱名词”，除单数主格外一律加-(e)n
\end{itemize}
...
\begin{itemize}
    \item 格：\\
          依赖句中角色，由动/介决定
    \item 疑问代词：\\
          疑代形同阳、中定冠 (对应人、物)。属格特殊加-en \\
          (关系代词，指示代词类似deren,dessen)
\end{itemize}
...
\subsubsection{用法}
\begin{itemize}
    \item 表所属 (=von, 相当于英所有格 of the) \\
          das Haus Von meinem Bruder \\
          das Haus meines Bruders
    \item 搭配
          句子：Ich bin bei der Meinung, dass ... \\
          介词：iele Menschen treiben diesen Sport wegen der Gefahr und der Spannung. \\
\end{itemize}
\subsection{变格}

\subsection{宾格}
大部分带宾语动词是第四格，$v/t. \Rightarrow 可支配第四格$ \\
少数不及物动词只支配第三格。\\
双宾见\hyperref[chap:verb:double_object_order]{动词} \\
