...
\end{center}
\subsection{规则}
序数词由基数词派生来，合成基数变序数只变最末词(der einundzwanzigste, der hunderterst) \\
序数必带冠(同英)，变格同形。

\subsection{问第几}
Der/Das/Die wievielte ist ... ?
...
\subsection{问日期}
\begin{itemize}
    \item Q: Der wievielte ist heute?
    \item A: Heute ist ...
\end{itemize}

\subsection{问何日}
\begin{itemize}
    \item Q: Am wievielten ...?
    \item A: Am erst\textcolor{red}{en} Mai ...
\end{itemize}
...
\begin{itemize}
    \item 日用序数，月可用月名或序数：
          \begin{itemize}
              \item der erste Mai
              \item der erste fünfte
          \end{itemize}
    \item 注意变格：\\
          \begin{itemize}
              \item der erst\textcolor{red}{e} Mai \sqr[border=true]
              \item am erst\textcolor{red}{en} Mai \olive[border=true]
          \end{itemize}
    \item 年有零头，先千后零，年无零头，两两作读。\\
