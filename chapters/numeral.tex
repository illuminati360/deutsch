...
用法：量词+名词，单复看量词。阳中量词无复数，只有阴性量词变幅书。名词若可数要变复数。e.g.: 100 Gramm Käse kosten 99 Cent. \\
...
\subsection{时间读法}
null Uhr = 24 Uhr
\subsubsection{offiziell: 24 std.}
A:B = A Uhr B\\
if A = 1, eins \textrightarrow{ein} (e.g. 1:01 = ein Uhr eins) \\
\subsubsection{inoffiziell: 12 Std.}
\begin{center}
    \clock[hand=false]
\end{center}
...
\end{itemize}
注意der Punkt \square[color=green]
